...
public class TimeUtil {
    ...
    public static String getCurrentHour() {
        ...
        if (hour < 10) {
            return TimeUtil.getCurrentTime() + " 0" + hour;
        }
        return TimeUtil.getDateByString() + " " + hour;
    }
    ...
    public static String getCurrentHourBefore() {
        ...
        if (hour > 0) {
            ...
            if (hour < 10) {
                return TimeUtil.getDateByString() + " 0" + hour;
            }
            return TimeUtil.getDateByString() + " " + hour;
        }
        //获取当前日期前一天
        return TimeUtil.getBeforeDay() + " " + 23;
    }
     ...
     * 将标准时间GMT转换为时间
     */
    public static String standardDateToDate(String stringDate) throws ParseException{
        //String s = "Thu Oct 16 07:13:48 GMT 2014        Thu Dec 09 2021 16:38:12 GMT";
    ...
    public static void main(String[] args) {
        System.out.println(TimeUtil.getQuartList());
    }
}
